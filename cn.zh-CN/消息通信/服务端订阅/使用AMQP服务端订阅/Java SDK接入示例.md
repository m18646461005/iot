---
keyword: [IoT, 物联网平台, AMQP, 服务端订阅设备消息, Java JMS]
---
...
本示例使用的开发环境为JDK 1.7及以上版本。

## 下载SDK

AMQP SDK为开源SDK。如果您使用Java开发语言，推荐使用Apache Qpid JMS客户端。请访问[Qpid JMS 0.47.0](https://qpid.apache.org/releases/qpid-jms-0.47.0/index.html)下载客户端和查看使用说明。
